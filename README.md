...
Hub de projetos com rastreamento de mãos (MediaPipe) no navegador.
...
- **Mão esquerda aberta:** poder Naruto
- **Pinça ou indicador:** desenhar na tela
- **Limpar:** apaga o desenho

### Requisitos
- Navegador com câmera e permissão de webcam
